...
Para lograrlo:
Primero analicé el comportamiento de la corrosión a lo largo del tiempo, observando mediante gráficos que su impacto tiende a desacelerarse con los años.
A partir de este análisis, utilicé una fórmula exponencial para realizar un calculo en mi cuaderno, la cual tuve que pedir ayuda a la IA para recrearla con python porque no tenia idea de como hacerlo jeje.
También incorporé nuevas variables como la tasa de corrosión y la presión específica, lo que permitió mejorar el modelo de regresión pasando de un 94% de precisión a un 99%.
